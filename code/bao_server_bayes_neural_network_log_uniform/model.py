...
from src.methods.bayes.variational.net import LogUniformVarLayer, VarBayesNet
...
class BaoRegression:
    ...
    def load(self, path):
        ...
        lin_layer_2 = LogUniformVarLayer(self.__net.tree_conv[-1])
        ...
        self.__net_distribution.set_map_params()
    ...
    def fit(self, X, y, lr=0.001, beta=0.01, max_epoch=100):
        ...
        bayes_loss_fn = LogUniformVarKLLoss()
